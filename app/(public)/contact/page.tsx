          ...
          <div className="space-y-5">
            {settings.contact_email && (
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href={`mailto:${settings.contact_email}`} className="text-primary-600 dark:text-primary-400 text-sm hover:underline">
                    {settings.contact_email}
                  </a>
                </div>
              </div>
            ...
            {settings.contact_phone && (
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-sm font-semibold text-slate-700 dark:text-slate-300 mb-0.5">Phone</p>
                  <a href={`tel:${settings.contact_phone}`} className="text-primary-600 dark:text-primary-400 text-sm hover:underline">
                    {settings.contact_phone}
                  </a>
                </div>
              </div>
            ...
            {settings.contact_location && (
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm">{settings.contact_location}</p>
                </div>
              </div>
            )}
          ...
          <div className="mt-8 pt-8 border-t border-slate-200 dark:border-slate-800">
            ...
            <div className="flex gap-3">
              ...
              {settings.social_github && (
                <a href={settings.social_github} target="_blank" rel="noopener noreferrer"
                  className="w-9 h-9 bg-slate-100 dark:bg-slate-800 hover:bg-primary-100 dark:hover:bg-primary-900/30 rounded-lg flex items-center justify-center text-slate-500 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
