...
import { changeAdminPassword, type PasswordChangeState } from '@/app/actions/admin';
...
export default function PasswordChangeForm() {
  const [state, action] = useActionState<PasswordChangeState, FormData>(changeAdminPassword, {});
