    ...
    <aside className="w-64 bg-slate-900 border-r border-slate-800 flex flex-col shrink-0 min-h-screen">
      ...
      <div className="h-16 flex items-center px-6 border-b border-slate-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-slate-500 text-xs mt-0.5">Portfolio CMS</p>
          </div>
        </div>
      </div>
          ...
          return (
            ...
            >
              ...
              {item.href === '/admin/messages' && unreadMessages > 0 && (
                <span className="ml-auto min-w-[20px] h-5 px-1.5 bg-primary-600 text-white text-xs font-bold rounded-full flex items-center justify-center">
      ...
      <div className="p-4 border-t border-slate-800">
        <a
          ...
          className="flex items-center gap-2 px-3 py-2.5 rounded-lg text-sm text-slate-500 hover:text-slate-300 hover:bg-slate-800 transition-colors"
        >
