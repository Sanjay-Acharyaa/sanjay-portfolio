...
const experience = [
  {
    ...
    period: '2020 – Present',
    description: 'Structural analysis and design of residential and commercial buildings. Transportation planning and traffic impact assessments. Water resources feasibility studies.',
  },
  // Add more roles here
];
...
const skills = [
  { category: 'Structural', items: ['AutoCAD', 'STAAD Pro', 'SAP2000', 'ETABS'] },
  { category: 'Transportation', items: ['Highway Design', 'Traffic Analysis', 'GIS', 'MX Road'] },
  { category: 'Water Resources', items: ['HEC-RAS', 'EPANET', 'WaterCAD', 'ArcGIS'] },
  { category: 'Management', items: ['MS Project', 'Primavera', 'Cost Estimation', 'QA/QC'] },
];

const certifications = [
  'Nepal Engineering Council (NEC) Registered Engineer',
  // Add more certifications here
];

const fade = { hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0, transition: { duration: 0.6 } } };

export default function AboutClient({ linkedin, github }: { linkedin?: string; github?: string }) {
  return (
    <div className="max-w-5xl mx-auto px-4 py-24">
      ...
      <motion.div initial="hidden" animate="visible" variants={fade} className="mb-20">
        <div className="flex flex-col md:flex-row gap-10 items-start">
          ...
          <div>
            <h1 className="text-5xl font-bold text-slate-900 dark:text-white mb-3">Sanjay Acharya</h1>
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed mb-6 max-w-2xl">
              Civil engineer with expertise in structural design, transportation systems, and water resources management.
              Committed to delivering safe, sustainable, and cost-effective engineering solutions for complex infrastructure challenges in Nepal and beyond.
            </p>
        ...
        <div className="lg:col-span-2 space-y-14">
          ...
          <motion.section initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fade}>
            ...
            <div className="space-y-4">
              {education.map((edu, i) => (
                <div key={i} className="p-5 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-700">
          ...
          <motion.section initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fade}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {skills.map((group) => (
                <div key={group.category} className="p-5 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-700">
        ...
        <aside className="space-y-6">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fade}
            ...
            <div className="space-y-2">
              <a href={linkedin || 'https://linkedin.com/in/sanjay-acharya'} target="_blank" rel="noopener noreferrer"
              ...
              <a href={github || 'https://github.com/Sanjay-Acharyaa'} target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-3 text-slate-600 dark:text-slate-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors text-sm">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
